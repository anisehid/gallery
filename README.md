...
# Layouts available
here are some layouts already built, generated from anise-kbd's desc-gen.

## ANISE60B
<img src="imgs/anise60b.jpg" alt="kbd" style="width:42%;"/>
this is the basic layout which was built first, the bottom row is squeezed for the reason that I want to use 2u space, and make my thumb easier to type key next to space.
...
larger one with FN row and a nav cluster with somewhat normal position.
